...
<%
	...
	// loginUser에 담긴데이터
	// 로그인 전 : null
	// 로그인 후 : 로그인한 회원정보 담은 Member 객체
	
	// 알림메시지 추출하기
	String alertMsg = (String)session.getAttribute("alertMsg");
	// 서비스 요청 동작 전 : null
	// 서비스 요청 후 알람메시지 있을땐 : 메시지 문구
...
<body>
    ...
    <script>
    	...
    	// script 태그 내에서도 자바코드 스크립틀릿 또는 표현식 이용하여 처리 가능
    	var msg = "<%=alertMsg%>"; // 로그인 성공 또는 null
    	
    	// null이 아닐경우에 alert띄워주기
    	if(msg != "null"){
    		alert(msg);
    	...
    	function enrollPage(){
    		...
    		// 단순한 정적페이지 이동시에도 servlet을 거쳐서 서버에서 매핑처리 할 수 있도록 할 것
    ...
    <!-- ${pageContext.request.contextPath } -> 너무길면 만들어 놓고 써도 됨 -->
    <!-- <% %>에 담긴 거랑은 다른개념이다. -->
    <!--  
    ...
    <div class="nav-area" align="center">
        ...
        <div class="menu"><a href="${pageContext.request.contextPath }/list.bo?currentPage=1">일반게시판</a></div>
